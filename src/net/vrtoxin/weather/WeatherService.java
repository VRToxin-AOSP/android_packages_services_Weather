...
public class WeatherService extends Service {
    ...
    private static final String ACTION_UPDATE = "net.vrtoxin.weather.ACTION_UPDATE";
    private static final String ACTION_ALARM = "net.vrtoxin.weather.ACTION_ALARM";

    private static final String EXTRA_FORCE = "force";

    static final String ACTION_CANCEL_LOCATION_UPDATE =
            "net.vrtoxin.weather.CANCEL_LOCATION_UPDATE";
